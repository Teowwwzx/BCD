        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin
                ? 'Sign in to your BCD Marketplace account'
                : 'Join the BCD Marketplace community'
              }
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 ${errors.email ? 'border-red-300' : 'border-gray-300'
                  }`}
            ...
            <div>
              ...
              <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 ${errors.password ? 'border-red-300' : 'border-gray-300'
                    }`}
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 ${errors.confirmPassword ? 'border-red-300' : 'border-gray-300'
                    }`}
